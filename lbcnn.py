...
class LBC(tf.keras.layers.Layer):
    ...
    def __init__(self, rank, anchor_weights, kernel_size, sub_layer1, sub_layer2, strides=1, padding='valid', activation='relu', kernel_initializer='glorot_uniform', kernel_regularizer=None, activity_regularizer=None, kernel_constraint=None, trainable=True, name=None, **kwargs):
...
class LBC2D(LBC):
    ...
    def __init__(self, anchor_weights, strides=1, padding='valid', kernel_initializer='glorot_uniform', kernel_regularizer=None, activity_regularizer=None, kernel_constraint=None, **kwargs):
